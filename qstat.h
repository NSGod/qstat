...
void plist_display_player_info( struct qserver *server);
...
void plist_display_ventrilo_player_info(struct qserver *server);
void plist_display_starmade_player_info(struct qserver *server);
...
struct _server_type {
    ...
    DisplayFunc display_plist_player_func;
    DisplayFunc display_plist_rule_func;
...
/* SERVER BUILTIN TYPES */
	...
	server_type builtin_types[] =
	{
		...
		plist_display_q_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_qw_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_q2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
			send_qwserver_request_packet,   /* status_query_func */
			NULL,                           /* rule_query_func */
			NULL,                           /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_doom3_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
			send_qwserver_request_packet,   /* status_query_func */
			NULL,                           /* rule_query_func */
			NULL,                           /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_hl2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_unreal_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_halflife_player_info,      /* display_json_player_func */
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_halflife_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
			send_qwserver_request_packet,           /* status_query_func */
			NULL,                                   /* rule_query_func */
			NULL,                                   /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_tribes_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_bfris_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_tribes2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_descent3_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
			send_gps_request_packet,                /* status_query_func */
			NULL,                                   /* rule_query_func */
			NULL,                                   /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_ghostrecon_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
			send_qserver_request_packet,            /* status_query_func */
			NULL,                                   /* rule_query_func */
			NULL,                                   /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_eye_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
			send_qserver_request_packet,    /* status_query_func */
			NULL,                           /* rule_query_func */
			NULL,                           /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_gs2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_armyops_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
			send_gs2_request_packet,                /* status_query_func */
			NULL,                                   /* rule_query_func */
			NULL,                                   /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_ravenshield_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
			send_qserver_request_packet,            /* status_query_func */
			NULL,                                   /* rule_query_func */
			NULL,                                   /* player_query_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_savage_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
		plist_display_farcry_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
...
/* --- MASTER SERVERS --- */
		...
		NULL,	/* display_plist_player_func */
		NULL,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,                              /* display_json_rule_func */
		plist_display_ts2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,                      /* display_json_rule_func */
		plist_display_tm_player_info,		/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_player_info,       /* display_json_player_func */
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_haze_player_info,	/* display_plist_player_func */
		plist_display_server_rules,	/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,                              /* display_json_rule_func */
		plist_display_wic_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_fl_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_tee_player_info,		/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,                              /* display_json_rule_func */
		plist_display_ts3_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,      /* display_json_rule_func */
		plist_display_bfbc2_player_info,	/* display_plist_player_func */
		plist_display_server_rules,		/* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
			plist_display_ventrilo_player_info,     /* display_plist_player_func */
			plist_display_server_rules,             /* display_plist_rule_func */
		...
		},
		{
			...
			json_display_player_info,       /* display_json_player_func */
			json_display_server_rules,      /* display_json_rule_func */
			plist_display_player_info,      /* display_plist_player_func */
			plist_display_server_rules,     /* display_plist_rule_func */
		...
		},
		{
			...
			json_display_server_rules,              /* display_json_rule_func */
			plist_display_starmade_player_info,     /* display_plist_player_func */
			plist_display_server_rules,             /* display_plist_rule_func */
